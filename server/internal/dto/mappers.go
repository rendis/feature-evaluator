...
func ToFeatureResponse(f *feature.Feature, tagMap map[string]tag.Tag, tiers []TierRef, packs ...[]PackRef) FeatureResponse {
	...
	return FeatureResponse{
		...
		Enabled:             f.Enabled,
		EvalCacheEnabled:    f.EvalCacheEnabled,
		EvalCacheTTLSeconds: f.EvalCacheTTLSeconds,
...
func ToSegmentResponse(s *segment.Segment) SegmentResponse {
	return SegmentResponse{
		...
		Metadata:                  s.Metadata,
		MembershipCacheEnabled:    s.MembershipCacheEnabled,
		MembershipCacheTTLSeconds: s.MembershipCacheTTLSeconds,
		RecordCacheEnabled:        s.RecordCacheEnabled,
		RecordCacheTTLSeconds:     s.RecordCacheTTLSeconds,
